...
const Guest = () => {
  return (
    <div className='font-sans bg-white dark:bg-black text-gray-800 dark:text-gray-200 transition-all duration-300 min-h-screen'>
      {/* Hero Section */}
      <section className='relative overflow-hidden flex flex-col items-center justify-center text-center py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-8 bg-gray-50 dark:bg-black'>
        ...
        <div className='relative z-10 max-w-4xl mx-auto w-full '>
          ...
          <p className='text-base sm:text-lg md:text-xl lg:text-2xl mb-6 sm:mb-8 text-gray-700 dark:text-gray-300 leading-relaxed max-w-3xl mx-auto px-2 sm:px-0'>
          ...
          <div className='flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-8 sm:mb-12 px-2 sm:px-0'>
            ...
            <button className='group border-2 border-emerald-500/30 dark:border-emerald-400/30 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 hover:border-emerald-500/50 dark:hover:border-emerald-400/50 px-6 sm:px-8 py-3 sm:py-4 rounded-xl sm:rounded-2xl font-semibold transition-all duration-300 transform hover:-translate-y-0.5 hover:scale-105'>
              Learn More
            </button>
          </div>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 max-w-4xl mx-auto px-2 sm:px-0'>
            <div className='dark:bg-black text-gray-800 dark:text-gray-200 p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg border border-gray-200/50 dark:border-gray-700/50 hover:shadow-xl transition-all duration-300'>
            ...
            <div className='dark:bg-black text-gray-800 dark:text-gray-200 backdrop-blur-sm p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg border border-gray-100/50 dark:border-gray-700/50 sm:col-span-2 md:col-span-1'>
        ...
        <div className='max-w-4xl mx-auto'>
          <div className='text-center mb-10 sm:mb-12 md:mb-16'>
            ...
            <p className='text-sm sm:text-base md:text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto px-2 sm:px-0'>
              Everything you need to know about BudgetBee AI and how it can
              transform your financial management.
            </p>
          </div>

          <div className='space-y-4 sm:space-y-6'>
            <div className='group dark:bg-black text-gray-800 dark:text-gray-200  p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg border border-gray-200/50 dark:border-gray-700/50 hover:shadow-xl transition-all duration-300'>
              <div className='flex items-start gap-3 sm:gap-4'>
                 
                <div className='flex-1'>
                  <h3 className='text-lg sm:text-xl font-bold text-gray-900 dark:text-gray-100 mb-2 sm:mb-3'>
                    What is BudgetBee AI?
                  </h3>
                  <p className='text-sm sm:text-base text-gray-600 dark:text-gray-400 leading-relaxed'>
                    BudgetBee AI is an intelligent financial management
            ...
            <div className='group dark:bg-black text-gray-800 dark:text-gray-200  p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg border border-gray-200/50 dark:border-gray-700/50 hover:shadow-xl transition-all duration-300'>
              <div className='flex items-start gap-3 sm:gap-4'>
                ...
                <div className='flex-1'>
                  <h3 className='text-lg sm:text-xl font-bold text-gray-900 dark:text-gray-100 mb-2 sm:mb-3'>
                    Is BudgetBee AI free?
                  </h3>
                  <p className='text-sm sm:text-base text-gray-600 dark:text-gray-400 leading-relaxed'>
                    Yes, BudgetBee AI offers a free plan with basic AI
        ...
        <div className='max-w-6xl mx-auto'>
          <div className='text-center mb-10 sm:mb-12 md:mb-16'>
            ...
            <p className='text-sm sm:text-base md:text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto px-2 sm:px-0'>
              ...
              financial habits with BudgetBee AI.
            </p>
          </div>

          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8'>
            <div className='group relative dark:bg-black text-gray-800 dark:text-gray-200 p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1'>
              ...
              <div className='relative z-10'>
                ...
                <p className='text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4'>
                  &ldquo;BudgetBee AI has completely transformed my
            ...
            <div className='group relative dark:bg-black text-gray-800 dark:text-gray-200  dark:text-gray-200 p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1'>
              ...
              <div className='relative z-10'>
                ...
                <p className='text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4'>
                  &ldquo;The AI-powered insights from BudgetBee have helped
            ...
            <div className='group relative dark:bg-black text-gray-800 dark:text-gray-200  p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 sm:col-span-2 lg:col-span-1'>
              ...
              <div className='relative z-10'>
                ...
                <p className='text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4'>
                  &ldquo;BudgetBee AI is so intelligent and easy to use.

...
const RecordChart = async () => {
  ...
  if (error) {
    return (
      <div className='dark:bg-black text-gray-800 dark:text-gray-200    backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl'>
  ...
  if (!records || records.length === 0) {
    return (
      <div className='dark:bg-black text-gray-800 dark:text-gray-200 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-300'>
        <div className='flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6'>

...
const AIInsights = () => {
  ...
  if (isLoading) {
    return (
      <div className='dark:bg-black text-gray-800 dark:text-gray-200 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50'>
